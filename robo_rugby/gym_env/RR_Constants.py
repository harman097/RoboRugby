...
ARENA_WIDTH = 800 if GAME_MODE else 400
ARENA_HEIGHT = 800 if GAME_MODE else 400
ROBOT_LENGTH = 20
ROBOT_WIDTH= 40
ROBOT_WIDTH_BODY = 32
ROBOT_WIDTH_TRACKS = 8
ROBOT_VEL = 3 if GAME_MODE else 12
MOVES_PER_FRAME = ROBOT_VEL
ROBOT_ANGULAR_VEL_ONE = .9  # one motor rotating around other track
...
FRAMERATE = 120 if GAME_MODE else 30
GAME_LENGTH_MINS = 3 if GAME_MODE else .15
...
NUM_ROBOTS_GRUMPY = 2 if GAME_MODE else 0
